...
class HGModel(DqnTfModel):
    def __init__(self, state_shape, n_actions, discount_factor, **kwargs):
        super(HGModel, self).__init__(state_shape, n_actions, discount_factor, **kwargs)
...
if not os.path.isdir("weights"):
    os.mkdir("weights")
weights_load_path = join("weights", "dqn_health_gathering.ckpt")
weights_save_path = join("weights", "dqn_health_gathering.ckpt")
